...
globalConfig = {"codeVer":"19.3.0","products":{},"storage":"COOKIE","brainUrl":"https://brain.foresee.com","recUrl":"https://record.foresee.com/rec/","surveyUrl":"https://survey.foreseeresults.com/survey/display","analyticsUrl":"https://analytics.foresee.com/ingest/events","staticUrl":"https://static.foresee.com","alwaysOnLatest":0,"modernSurveyUrl":"https://cxsurvey.foresee.com/sv","customerId":"iEe9LsWbrrchWWBOTkSdiA==","surveyAsyncCurl":"s.foresee.com","siteKey":"bjs-gov","environment":"production"};
...
productConfig.trigger = ({
  ...
  "check": function() {
    ...
    recconfig = {
      ...
      clientId: "bjs-gov",
      rec_transport_url: "https://record.foresee.com/rec/",
      brainurl: "https://brain.foresee.com",
      advancedSettings: {
        layout: "CENTERFIXED",
        replay_pools: [{
        ...
        svgCaptureEnabled: !1,
        scrollEls: null,
        useEleMutation: !(document.addEventListener || !navigator.userAgent.indexOf("MSIE")),
        regexScrub: [],
        lowFidelity: [],
        watchNodeList: "",
        keepComments: !1,
